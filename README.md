...
Smooth scroll dengan Lenis, dilengkapi indikator progres scroll.
Animasi scroll memakai GSAP + ScrollTrigger (lini masa cerita, marquee, dll).
...
Ikon memakai Font Awesome (tanpa emoji).
...
Font Awesome 7	Ikon (bulan/matahari, hati, silang, panah)
